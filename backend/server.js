...
function getAgeBasedFreeSection(birthYear, maritalStatus) {
  ...
  if (group === 'young') {
    return `===지금 이 시기===
이 사람은 현재 ${age}세입니다. (350~450자)

📌 타고난 공부 스타일 · 빛나는 재능
이 사람만의 특징이 드러나야 해요.

📌 지금 이 시기 학업 에너지 흐름
지금 학업 에너지가 오르는 흐름인지 내려가는 흐름인지 배경과 이유를 충분히 설명하세요. 맨 마지막 1~2문장에만 "정확히 언제부터 언제까지가 중요한 시기인지" 구체적인 시기를 결론으로 콕 집어 제시하세요. 그 앞부분에는 구체적 시기를 언급하지 마세요.
...
📌 지금 이 시기 인연운 흐름
지금 인연운이 어떤 흐름인지(다가오는 흐름인지, 정체기인지) 배경과 이유를 충분히 설명하세요. "언제 만나는지" 정확한 시기는 알려주지 마세요. 대신 맨 마지막 1~2문장에만 "지금 이 시기에 정확히 어떤 태도·선택을 해야 인연이 앞당겨지는지" 핵심 결론만 결정적으로 못박아 배치하세요. 그 앞부분에서는 그 결론을 미리 언급하지 마세요.
...
🔒 이 패턴을 알면 연애가 달라집니다. 인연을 만나는 구체적 시기·이 사람에게 맞는 배우자 유형·결혼 타이밍은 전체 분석에서 확인하세요`;
    ...
    return `===지금 이 시기===
이 사람은 현재 ${age}세 기혼입니다. (350~450자)

📌 지금 부부 에너지 흐름
강한 부분과 약한 부분을 정확하게.

📌 이 시기 부부 관계 방향
지금 부부 관계가 어느 방향으로 가는지 배경과 이유를 충분히 설명하세요. 맨 마지막 1~2문장에만 "정확히 언제, 무엇을 조심해야 관계가 안정되는지" 핵심 결론을 결정적으로 못박아 배치하세요. 그 앞부분에서는 그 결론을 미리 언급하지 마세요.
...
📌 현재 시기의 의미와 방향
지금 이 시기가 어떤 의미를 갖는지, 왜 그런 흐름인지 배경을 충분히 설명하세요. 맨 마지막 1~2문장에만 "정확히 몇 세 전후가 전환점인지" 구체적인 나이 숫자를 결론으로 콕 집어 제시하세요. 그 앞부분에는 구체적 나이를 언급하지 마세요.
...
- 핵심 항목은 1. 2. 3. 번호로 나열하고 각 항목 사이 빈 줄 추가.
- 한 단락 최대 3줄.
- "맨 마지막 1~2문장에만 결론을 배치하라"는 지시가 있는 📌 항목은, 설명·배경·이유는 충분히 자세하게 쓰고 구체적인 숫자·시기·명칭이 담긴 결정적 결론 문장만 정말로 맨 마지막 1~2문장에 배치하세요. 화면에서는 그 마지막 문장만 블러 처리되고 나머지는 전부 그대로 공개됩니다.
...
📌 돈 관련해서 반복되는 실수 패턴
이 사람이 돈에서 같은 실수를 반복하는 패턴을 구체적으로 짚어주세요. 위 항목과는 다른 상황으로 구체적 장면을 1개 이상 만들어서 넣으세요. (예시 형식: "누군가의 부탁을 거절하지 못해서 돈이 나갔던 순간이 반복됐을 거예요" 처럼, 이 사주 특성과 연결된 실제 실수 장면을 그려주세요.) 이 패턴에 대한 설명은 충분히 자세하게 쓰고, 맨 마지막 1~2문장에만 "정확히 어떤 행동을 하지 말아야 하는지" 핵심 결론을 결정적으로 못박아 배치하세요. 그 앞부분에서는 결론을 미리 흘리지 마세요.

📌 돈이 크게 움직이는 시기
이 시기가 왜 중요한지, 어떤 흐름 때문에 그런지 배경을 충분히 설명하세요. 맨 마지막 1~2문장에만 정확한 나이나 시기 숫자를 콕 집어 결론으로 제시하세요 (예: "정확히는 OO세 전후가 가장 중요한 전환점이에요"). 그 앞부분에는 나이·시기 숫자를 언급하지 마세요.
