...
첫 문단: 현재 대운이 어떤 기운인지, 이 대운이 이 사람에게 어떤 의미인지. 재물·직업·인간관계 중 어떤 영역이 가장 크게 움직이는지.
두 번째 문단: 현재 대운에서 가장 좋은 시기와 조심해야 할 시기. 지금 올라타야 할 흐름과 피해야 할 행동.
세 번째 문단: 다음 대운이 언제 시작되는지, 어떤 기운으로 바뀌는지. 지금부터 준비하면 달라지는 것.
마지막 줄: 이 대운을 가장 잘 활용하는 핵심 한 가지.
