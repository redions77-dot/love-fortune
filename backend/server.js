...
2. 말투: 따뜻하고 공감 가는 큰언니 말투. "그래, 맞아. 네가 그럴 수밖에 없었어" 같은 공감이 먼저 나와야 해요. 딱딱한 분석 말투 금지
...
===이 아이의 행운 아이템===
(200~250자) 이 사주에서 이 아이에게 힘이 되는 것들을 구체적으로.
- 행운 색깔: (1~2가지, 이유 포함)
- 행운 숫자: (1~2개, 이유 포함)
- 행운 방향: (이 아이 방에 배치하면 좋은 방향)
- 추천 소품·환경: (이 아이 기질에 맞는 물건이나 공간 특징 1~2가지)
부모가 실생활에서 바로 활용할 수 있도록 쉽게 설명해주세요.`;
    try {
      if (!isPaid) {
