...
세 번째 문단 — 추천학과 5개: 먼저 이 아이의 사주 구조에서 왜 이 학과들이 맞는지 충분히 풀어서 설명하세요 (기질과 오행 근거로 도입부 작성). 그 뒤에 구체적 학과명 5개를 각각 1줄 이유와 함께 제시하세요. 반드시 구체적 학과명으로 작성하세요 (예: 컴퓨터공학과, 산업디자인학과, 임상심리학과, 경영학과, 건축학과). "공학계열" "예체능 분야" 같은 추상적 표현 금지.
