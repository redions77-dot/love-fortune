...
첫 문단: 지금 이 시기(2026~2028) — 이 사람에게 어떤 시기인지. 기회인지 준비 시기인지 솔직하게. 지금 해야 할 것과 하지 말아야 할 것.
두 번째 문단: 중간 시기(2029~2031) — 이 사주에서 어떤 변화가 예상되는지. 재물·직업·인간관계 중 가장 크게 움직이는 영역.
세 번째 문단: 후반 시기(2032~2036) — 이 사람의 사주가 꽃피는 시기가 언제인지. 지금부터 준비하면 달라지는 것.
마지막 줄: 앞으로 10년 중 이 사람에게 가장 중요한 해 하나만 꼽아주세요.

===2026년 하반기 월별 운세===
(900~1000자) 2026년 6월부터 12월까지 월별로 구체적으로.
형식: 7월: (내용) / 8월: (내용) / 9월: (내용) / 10월: (내용) / 11월: (내용) / 12월: (내용)
각 달마다 재물·직업·인간관계 중 가장 중요한 흐름 하나씩. 모든 달이 좋거나 나쁠 수 없어요.
마지막 줄: 하반기 중 가장 조심해야 할 달과 가장 적극적으로 움직여야 할 달을 각각 하나씩.

===2027년 연간 운세===
(900~1000자) 2027년 전체 흐름.
첫 문단: 2027년이 이 사람에게 어떤 해인지 전체적으로. 상승 기운인지 안정 기운인지 전환점인지.
두 번째 문단: 2027년 상반기(1~6월) 흐름 — 재물·직업·인간관계 핵심 포인트.
세 번째 문단: 2027년 하반기(7~12월) 흐름 — 특히 조심해야 할 시기와 적극적으로 움직여야 할 시기.
마지막 줄: 2027년을 잘 보내기 위한 핵심 조언 한 문장.

===귀인 분석===
(900~1000자) 이 사주에서 진짜 내 인생을 바꿔줄 귀인은 어떤 사람인지.
첫 문단: 귀인의 특징 — 어떤 분야 사람인지, 어떤 성격인지, 어떤 상황에서 나타나는지 구체적으로.
두 번째 문단: 귀인을 만날 가능성이 높은 시기와 상황. 반대로 내 발목을 잡는 사람의 특징도 짚어주세요.
마지막 줄: 귀인을 알아보고 잡는 이 사주만의 방법.

===지금 당장 해야 할 것 vs 하지 말아야 할 것===
(900~1000자) 이 사주 기준으로 지금 이 시기에 맞는 행동 전략.
첫 문단: 지금 당장 시작하면 좋은 것 2~3가지. 이 사주에서 지금이 왜 좋은 타이밍인지 근거와 함께.
두 번째 문단: 지금은 하지 말아야 할 것 2~3가지. 왜 지금은 안 맞는지 사주 근거로.
마지막 줄: 이 사주로 2027년을 맞이하기 위해 지금 가장 중요한 한 가지.`;
