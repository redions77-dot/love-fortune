...
1. 호칭: 분석 대상을 항상 "당신"으로만. "형님" "누나" "어르신" 등 절대 금지
2. 쉬운 말: 어려운 한자 용어 금지. "인성" → "나를 도와주는 기운", "식신" → "타고난 재능"
3. 나열 금지: 숫자 목록(1. 2. 3.)이나 하이픈(-) 금지 — 자연스러운 문장으로
4. 마크다운 금지: **, ##, * 등 기호 사용 금지
5. 문단 구성: 첫 문단은 공감 가는 설명, 둘째 문단은 사주 근거
6. 차별화: 이 사람의 사주에서 실제로 두드러지는 특징만. 누구에게나 해당되는 말은 금지
7. 연도 언급: 이 사주에서 실제로 중요한 해일 때만 언급. 아니면 굳이 쓰지 마세요
8. 요일 언급 절대 금지: "월요일에 태어난", "토요일생" 등 요일 표현은 사주와 무관하므로 절대 쓰지 마세요
9. 유행어·밈: 전체에서 최대 1개`;
...
===타고난 기질===
(300~350자) 이 아이의 본질적인 성격을 부모가 "맞아!"라고 느낄 만큼 정확하게.
첫 문단: 이 아이를 한 마디로 표현하는 이미지로 시작해서, 집에서 보이는 행동 패턴과 감정 표현 방식, 친구들 사이에서 어떤 아이인지를 구체적으로 써주세요.
두 번째 문단: 사주 구조로 왜 이런 기질이 나오는지 부모가 이해하기 쉽게 설명하세요.

===재능의 씨앗===
(250~300자) 이 아이가 타고난 재능이 어느 방향으로 향하는지.
첫 문단: 이 아이가 유독 빠져드는 것, 반복해도 안 지치는 것, 가르쳐주지 않아도 잘하는 것이 무엇인지 구체적으로. 이과/문과/예체능 방향 중 어디서 두각을 나타낼지.
두 번째 문단: 지금 이 시기(${childAge}세) 이 아이의 에너지 흐름이 어떤지, 어떤 자극을 줄 때 눈이 빛나는지.
마지막 줄: "📚 구체적 직업 방향·입시 타이밍·부모 양육법은 전체 분석에서 확인하세요"

===이 아이가 힘든 순간===
(200~250자) 이 아이가 스트레스받는 상황과 그 이유를 부모가 이해할 수 있게.
부모가 "아, 그래서 그랬구나"라고 느낄 내용이어야 해요. 단점이 아니라 기질의 특성으로 설명해주세요.
마지막 줄: "💡 이 아이를 키우는 핵심 비법·학습법·진로 타이밍은 전체 분석에서 확인하세요"`;
