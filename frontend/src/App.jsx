  ...
  if (screen === 'landing') {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#050D1F' }}>
        <div style={{ position: 'relative', overflow: 'hidden', minHeight: 'auto' }}>
          ...
          {[...Array(30)].map((_, i) => <div key={i} style={{ position: 'absolute', width: i % 5 === 0 ? 2 : 1, height: i % 5 === 0 ? 2 : 1, borderRadius: '50%', background: i % 7 === 0 ? '#C9A84C' : 'white', opacity: 0.3 + (i % 3) * 0.15, top: `${(i * 37) % 100}%`, left: `${(i * 53) % 100}%`, pointerEvents: 'none' }}/>)}
