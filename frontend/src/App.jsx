          ...
          <div style={{ marginTop: 20, background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.4)', borderRadius: 12, padding: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <input
                ...
                style={{ flex: 1, padding: '10px 14px', fontSize: 13, border: '1px solid rgba(201,168,76,0.3)', borderRadius: 8, background: 'rgba(255,255,255,0.04)', color: '#FFFFFF', outline: 'none' }}
              />
