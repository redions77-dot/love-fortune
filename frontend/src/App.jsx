    ...
    {(serviceType === 'child'
     ...
     : [
          { title: '財運 · 인생 재물 전체',
            ...
            blurred: '20~30대는 흘러가는 구조였다면 지금부터는 쌓이는 구조로 바뀌는 시기예요. 이 사주에서 돈이 가장 크게 움직이는 나이대가 있고, 절대 하면 안 되는 돈 실수가 하나 있어요. 지금 이걸 모르면 그 시기를 그냥 흘려보낼 수 있어요.' },
          { title: '職 · 직업과 커리어',
            first: '이 사주에 딱 맞는 직업이 따로 있어요. ',
            blurred: '지금 하는 일이 맞는지 안 맞는지도 사주에서 보여요. 어떤 환경에서 능력이 폭발하는지, 직장인으로 갈지 자영업으로 갈지도 이 사주가 답을 갖고 있어요. 크게 도약할 수 있는 구체적인 시기도 보여요.' },
          { title: '富 · 투자와 부동산',
            first: '이 사주에서 절대 손대면 안 되는 투자가 있어요. ',
            blurred: '반대로 지금 이 사주에 가장 잘 맞는 자산 방향은 따로 있어요. 부동산이냐 금융이냐, 지금 사야 하냐 기다려야 하냐 — 이 사주 기준으로 답이 나와요. 실거주에 좋은 방향과 환경도 구체적으로 알 수 있어요.' },
          { title: '緣 · 사람과 인연',
            first: '진짜 내 편이 되어줄 사람의 특징이 보여요. ',
            blurred: '반대로 곁에 두면 반드시 손해보는 사람 유형도 있어요. 이 사주에서 인간관계가 꼬이는 패턴이 있는데, 그걸 알면 같은 실수를 반복하지 않을 수 있어요. 귀인이 나타나는 시기와 상황도 알 수 있어요.' },
          { title: '행운 아이템 전체',
            first: '이 사주의 행운 색깔·마스코트·방향·숫자·아이템이 있어요. ',
            blurred: '단순한 미신이 아니라 이 사주 기운과 맞는 환경을 만드는 거예요. 생각보다 일상에서 바로 써먹을 수 있는 것들이고, 실제로 운의 흐름을 바꾸는 데 도움이 돼요.' },
          { title: '道 · 이 사주로 잘 사는 법',
            first: '이 사주가 잘 풀리는 조건이 딱 2가지예요. ',
            blurred: '이것만 지키면 된다는 게 있고, 반대로 이 사주가 망하는 패턴도 하나 있어요. 지금 당장 오늘부터 바꿀 수 있는 행동 2가지가 있는데, 아는 것과 모르는 것의 차이가 생각보다 크게 나요.' },
        ]
   ).map((item, idx) => (
