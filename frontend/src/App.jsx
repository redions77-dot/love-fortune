      ...
      <div style={s.app}>
        <div id="gunghab-result-content" style={s.resultWrap}>
         ...
         <div style={{ background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 10, padding: '14px 16px', marginBottom: 10, marginTop: 16 }}>
          ...
          <button style={{ width: '100%', padding: '13px', fontSize: 14, background: 'none', border: '1px solid rgba(201,168,76,0.3)', borderRadius: 10, cursor: 'pointer', color: '#6B5B3E', marginTop: 10 }} onClick={handleRestart}>처음으로 돌아가기</button>
