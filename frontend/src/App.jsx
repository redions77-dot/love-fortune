    ...
    <div style={{ minHeight: '100vh', background: '#050D1F', display: 'flex', flexDirection: 'column' }}>
      ...
      <div id="deep-result-content" style={{ maxWidth: 480, margin: '0 auto', padding: '16px 16px 40px', width: '100%', boxSizing: 'border-box' }}>
        ...
        <div style={{ background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 10, padding: '14px 16px', marginBottom: 10 }}>
          ...
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.8)', lineHeight: 1.8, marginTop: 4 }}>📱 모바일: PDF가 새 탭으로 열리면 길게 눌러서 저장하세요.</p>
        </div>
        <button style={{ width: '100%', padding: '13px', fontSize: 15, fontWeight: 600, background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.4)', borderRadius: 10, cursor: 'pointer', color: '#C9A84C', marginBottom: 10 }} onClick={() => {
          ...
          window.html2pdf().set(opt).from(element).outputPdf('datauristring').then((dataUri) => {
